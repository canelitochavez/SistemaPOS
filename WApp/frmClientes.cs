...
namespace WApp
{
    public partial class frmClientes : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                int idCliente = new BLL_Cliente().Registrar(oCliente, out mensaje);
            ...
            {
                bool clienteModificadoConExito = new BLL_Cliente().Editar(oCliente, out mensaje);

                if (clienteModificadoConExito)
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Desea eliminar el Cliente?", "Eliminar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool clienteEliminadoConExito = new BLL_Cliente().Eliminar(oCliente, out mensaje);

                    if (clienteEliminadoConExito)
                    {
